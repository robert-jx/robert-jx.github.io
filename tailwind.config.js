      ...
      typography: (theme) => ({
        invert: {
          css: {
            ...
            '--tw-prose-pre-title-bg': 'var(--tw-prose-invert-pre-title-bg)',
        ...
        DEFAULT: {
          css: {
            ...
            '--tw-prose-pre-title-bg': theme('colors.zinc.900/0.9'),
            '--tw-prose-pre-border': theme('colors.zinc.600'),
            ...
            '--tw-prose-invert-pre-title-bg': 'rgb(0 0 0 / 0.4)',
